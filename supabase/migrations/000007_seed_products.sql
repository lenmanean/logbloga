...
-- Handle both old schema (name column) and new schema (title column)
INSERT INTO products (
  slug, name, title, description, category, price, original_price, 
...
(
  'web-apps',
  'Web Apps Package', -- name column (for old schema)
  'Web Apps Package', -- title column (for new schema)
...
(
  'social-media',
  'Social Media Package', -- name
  'Social Media Package', -- title
...
(
  'freelancing',
  'Freelancing Package', -- name
  'Freelancing Package', -- title
...
('ai-ecommerce-builder', 'AI-Powered E-Commerce Builder', 'AI-Powered E-Commerce Builder', 'Create stunning online stores with AI-assisted design and automation', 'web-apps', 299.00, 499.00, true, 'beginner', '6 weeks'),
('social-content-generator', 'Social Media Content Generator', 'Social Media Content Generator', 'Generate engaging posts, captions, and content calendars automatically', 'social-media', 149.00, 249.00, true, 'beginner', '4 weeks'),
('client-management-system', 'Client Management System', 'Client Management System', 'Streamline your agency workflow with AI-powered project management', 'agency', 399.00, 599.00, true, 'intermediate', '8 weeks'),
('freelancer-portfolio', 'Freelancer Portfolio Platform', 'Freelancer Portfolio Platform', 'Build a professional portfolio that attracts high-paying clients', 'freelancing', 199.00, 349.00, true, 'beginner', '3 weeks'),
('saas-dashboard-template', 'SaaS Dashboard Template', 'SaaS Dashboard Template', 'Modern dashboard template with AI analytics and reporting', 'web-apps', 249.00, NULL, false, 'intermediate', '5 weeks'),
('instagram-automation', 'Instagram Growth Automation', 'Instagram Growth Automation', 'Automate engagement and grow your Instagram following organically', 'social-media', 179.00, NULL, false, 'beginner', '4 weeks'),
('agency-proposal-generator', 'Agency Proposal Generator', 'Agency Proposal Generator', 'Create winning proposals in minutes with AI-powered templates', 'agency', 279.00, NULL, false, 'beginner', '2 weeks'),
('freelance-invoice-system', 'Freelance Invoice System', 'Freelance Invoice System', 'Professional invoicing and payment tracking for freelancers', 'freelancing', 129.00, NULL, false, 'beginner', '2 weeks'),
('api-integration-platform', 'API Integration Platform', 'API Integration Platform', 'Connect multiple services with AI-powered API integrations', 'web-apps', 349.00, NULL, false, 'advanced', '10 weeks'),
('tiktok-strategy', 'TikTok Content Strategy', 'TikTok Content Strategy', 'Viral content strategies and AI-powered trend analysis', 'social-media', 199.00, NULL, false, 'intermediate', '6 weeks'),
('team-collaboration-tool', 'Team Collaboration Tool', 'Team Collaboration Tool', 'AI-enhanced collaboration platform for distributed teams', 'agency', 449.00, NULL, false, 'intermediate', '9 weeks'),
('client-communication-system', 'Client Communication System', 'Client Communication System', 'Automate client updates and maintain professional communication', 'freelancing', 159.00, NULL, false, 'beginner', '3 weeks')
ON CONFLICT (slug) DO NOTHING;
