...
export async function middleware(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://*.supabase.co https://api.stripe.com https://js.stripe.com https://*.stripe.com https://resend.com wss://*.supabase.co https://vercel.live https://api.openai.com",
