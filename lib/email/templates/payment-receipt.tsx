...
export function PaymentReceiptEmail({ data }: PaymentReceiptEmailProps) {
  ...
  return (
    <Html>
      ...
      <Preview>
        {hasDoerCoupon
          ? `Thank you for your purchase! Receipt, digital products, and your DOER Pro coupon - ${order.orderNumber}`
          : `Thank you for your purchase! Receipt and digital products - ${order.orderNumber}`}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          {hasDoerCoupon && (
            <>
              <Hr style={hr} />
              <Section style={doerSection}>
                <Heading style={doerSectionHeading}>Bonus: 6 Months Free DOER Pro</Heading>
                <Text style={text}>
                ...
                <Text style={couponInstructions}>
                  1. Visit <Link href="https://usedoer.com/checkout?plan=pro&cycle=monthly" style={doerLink}>usedoer.com/checkout</Link> (Pro Monthly or choose Pro Annual)
                </Text>
                <Text style={couponInstructions}>
...
// DOER coupon section (inlined when doerCouponCode is present)
const doerSection = {
  margin: '24px 0',
};

const doerSectionHeading = {
  color: '#333',
  fontSize: '20px',
  fontWeight: 'bold',
  margin: '0 0 16px',
