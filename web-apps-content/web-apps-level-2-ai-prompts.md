...
This file contains ready-to-use prompts you can copy and paste directly into your AI coding assistant (such as Cursor, GitHub Copilot, or ChatGPT) for each step of the Web Apps Level 2 implementation plan. Each prompt is designed to be:
